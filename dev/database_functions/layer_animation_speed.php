<?php include("../db.php"); 
	...
	while($row_animation = $result_animation->fetch_assoc()) { 
        ...
        $sql = "UPDATE video_maker_layer_animations SET speed = '$speed'
        ...
        $sql2 = "INSERT INTO video_maker_layer_animations (layer_id, type, animation, speed, date)
            VALUES ('$layer_id', '$type', 'none', '$speed', '$date')";
